# -*- coding: utf-8 -*-
"""
Created on Thu Apr 23 17:41:29 2020
...
pulse_end = { 'J0738-4042':[635,780],'J0837-4135':[670,705], 'J0942-5552':[330,480],
        ...
        for key,d in intensity.items():
            ...
            for j in np.arange(len(cr)):
                ...
                if len(inner)>3:
                    ...
                    flag[j][inner[0]:inner[-1]] = cr[j][inner[0]:inner[-1]] #1
            ...
            length = wsum/wnum
            phase_length = length/abs(peak_end[0]-peak_end[-1])*abs(phase_peak[0]-phase_peak[-1])
...
information = pd.DataFrame(np.array(info),columns=('PSR','FREQ','INTENSITY','LENGTH'))
information.to_csv('./revised_v2/decoherence.csv')
